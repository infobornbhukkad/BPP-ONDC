...
@Entity
@Table(name = "bb_admin_panel_vendors", uniqueConstraints = { @UniqueConstraint(columnNames = "username") })
public class VendorObj {
	...
	public VendorObj(String storetype, String storename, String email, String address, String opted, String phone,
			String accId, String userId, String longitude, String latitude, String username, String createddt,
			String updateddt, String isOpen, String updateduserid, String cGST, String sGST, String offerPercen, String fssai,String gstn, String symbol,String short_desc,
			String long_desc, String symbol_name) {
