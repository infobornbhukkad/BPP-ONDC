...
@Entity
@Table(name = "bb_admin_panel_vendors_item_details_kirana" , uniqueConstraints = { @UniqueConstraint(columnNames = "id") })
@Data
public class ItemDetailsKirana {
	...
	public ItemDetailsKirana() {
		super();
	}

	public ItemDetailsKirana(@NotBlank String vendorid, @NotBlank String itemname, @NotBlank String itemcategory, String newCategory,
			@NotBlank String itemstatus, @NotBlank String itemquantity,	String newQuantity, 
			String symbol,String short_desc, String long_desc, String Item_image_1, String Item_image_2, String Item_image_3, String Item_image_4,
			String Item_image_1_name,String Item_image_2_name, String Item_image_3_name, String Item_image_4_name, String symbol_name,
			String unit, @NotBlank String itemprice, String createdDate,
			String updatedDate) {
		super();
