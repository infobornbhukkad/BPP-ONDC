...
@Service
public class SearchServiceLogisticBuyer
{
    ...
    public ResponseEntity<String> search(final Schema request) throws JsonProcessingException {
    	SearchServiceLogisticBuyer.log.info("Going to validate json request before sending to seller...");
    ...
    private String sendRequestToSeller(final Schema request) {
        ...
        SearchServiceLogisticBuyer.log.info("going to call seller id: {} with action: {}", (Object)context.getBppId(), (Object)action);
        ...
        request.getContext().setTtl(ttl);
        final String json = this.jsonUtil.toJson((Object)request);
        SearchServiceLogisticBuyer.log.info("final json to be send {}", (Object)json);
    ...
    static {
        log = LoggerFactory.getLogger((Class)SearchServiceLogisticBuyer.class);
    }
}
