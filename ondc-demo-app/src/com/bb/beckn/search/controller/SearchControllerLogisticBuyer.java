...
import com.bb.beckn.search.service.SearchServiceLogisticBuyer;
import org.slf4j.Logger;
import org.springframework.web.bind.annotation.RestController;

@RestController
public class SearchControllerLogisticBuyer
{
    private static final Logger log;
    @Autowired
    private SearchServiceLogisticBuyer service;
    @Autowired
    private JsonUtil jsonUtil;
    @Value("${beckn.entity.type}")
    private String entityType;
    
    @PostMapping({ "adaptor/search" })
    public ResponseEntity<String> search(@RequestBody final String body, @RequestHeader final HttpHeaders httpHeaders, final HttpServletRequest servletRequest) throws JsonProcessingException {
    	SearchControllerLogisticBuyer.log.info("The body in {} adaptor is {}", (Object)"search", (Object)this.jsonUtil.unpretty(body));
    	SearchControllerLogisticBuyer.log.info("Entity type is {}", (Object)this.entityType);
    ...
    static {
        log = LoggerFactory.getLogger((Class)SearchControllerLogisticBuyer.class);
    }
}
