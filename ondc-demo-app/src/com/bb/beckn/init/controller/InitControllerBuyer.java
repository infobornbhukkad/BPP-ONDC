...
@RestController
public class InitControllerBuyer
{
    private static final Logger log;
    @Autowired
    private InitServiceBuyer service;
    @Autowired
    private JsonUtil jsonUtil;
    @Value("${beckn.entity.type}")
    private String entityType;
    
    @PostMapping({ "/buyer/adaptor/init" })
    public ResponseEntity<String> init(@RequestBody final String body, @RequestHeader final HttpHeaders httpHeaders, final HttpServletRequest servletRequest) throws JsonProcessingException {
        InitControllerBuyer.log.info("The body in {} adaptor is {}", (Object)"init", (Object)this.jsonUtil.unpretty(body));
        InitControllerBuyer.log.info("Entity type is {}", (Object)this.entityType);
        ...
        return (ResponseEntity<String>)this.service.init(request);
    }
    
    static {
        log = LoggerFactory.getLogger((Class)InitControllerBuyer.class);
    }
}
