...
import com.bb.beckn.rating.service.RatingServiceSeller;
import org.slf4j.Logger;
import org.springframework.web.bind.annotation.RestController;

@RestController
public class RatingControllerSeller
{
    private static final Logger log;
    @Autowired
    private RatingServiceSeller service;
    @Autowired
    ...
    @PostMapping({ "/seller/adaptor/rating" })
    public ResponseEntity<String> rating(@RequestBody final String body, @RequestHeader final HttpHeaders httpHeaders, final HttpServletRequest servletRequest) throws JsonProcessingException {
        RatingControllerSeller.log.info("The body in {} adaptor is {}", (Object)"rating", (Object)this.jsonUtil.unpretty(body));
        RatingControllerSeller.log.info("Entity type is {}", (Object)this.entityType);
        ...
        RatingControllerSeller.log.info("does buyer {} requires to be authenticated ? {}", (Object)bapId, (Object)authenticate);
        if (authenticate) {
        ...
        return (ResponseEntity<String>)this.service.rating(httpHeaders, model);
    }
    ...
    static {
        log = LoggerFactory.getLogger((Class)RatingControllerSeller.class);
    }
}
