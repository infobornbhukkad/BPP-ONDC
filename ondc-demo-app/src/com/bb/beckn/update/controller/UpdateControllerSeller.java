...
import com.bb.beckn.update.service.UpdateServiceSeller;
import org.slf4j.Logger;
import org.springframework.web.bind.annotation.RestController;

@RestController
public class UpdateControllerSeller
{
    private static final Logger log;
    @Autowired
    private UpdateServiceSeller service;
    @Autowired
    ...
    @PostMapping({ "/seller/adaptor/update" })
    public ResponseEntity<String> update(@RequestBody final String body, @RequestHeader final HttpHeaders httpHeaders, final HttpServletRequest servletRequest) throws JsonProcessingException {
        UpdateControllerSeller.log.info("The body in {} adaptor is {}", (Object)"update", (Object)this.jsonUtil.unpretty(body));
        UpdateControllerSeller.log.info("Entity type is {}", (Object)this.entityType);
        ...
        UpdateControllerSeller.log.info("does buyer {} requires to be authenticated ? {}", (Object)bapId, (Object)authenticate);
        if (authenticate) {
        ...
        return (ResponseEntity<String>)this.service.update(httpHeaders, model);
    }
    ...
    static {
        log = LoggerFactory.getLogger((Class)UpdateControllerSeller.class);
    }
}
