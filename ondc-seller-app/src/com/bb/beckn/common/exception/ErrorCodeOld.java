...
public enum ErrorCodeOld
{
	...
	REQUEST_OR_RESPONSE_ALREADY_PROCESSED(30022, "Request or Response that has already been processed");
	
    private int code;
    private String message;
    
    private ErrorCodeOld(final int errorCode, final String errorMessage) {
        this.code = errorCode;
    ...
    private static /* synthetic */ ErrorCodeOld[] $values() {
        return new ErrorCodeOld[] { ErrorCodeOld.AUTH_FAILED, ErrorCodeOld.INVALID_KEY_ID_HEADER, ErrorCodeOld.INVALID_AUTH_HEADER, ErrorCodeOld.BAD_REQUEST, ErrorCodeOld.ALGORITHM_MISMATCH, ErrorCodeOld.REQUEST_EXPIRED, ErrorCodeOld.INVALID_HEADERS_PARAM, ErrorCodeOld.SIGNATURE_VERIFICATION_FAILED, ErrorCodeOld.REQ_DIGEST_MISMATCH, ErrorCodeOld.INVALID_REQUEST, ErrorCodeOld.REQUEST_ALREADY_IN_PROCESS, ErrorCodeOld.INVALID_DOMAIN, ErrorCodeOld.UNKNOWN_ERROR, ErrorCodeOld.REQUEST_ALREADY_PROCESSED, ErrorCodeOld.REQUESTED_TRANSACTION_IS_NOT_EXIST, ErrorCodeOld.INVALID_ACTION, ErrorCodeOld.INVALID_CONTENT_TYPE, ErrorCodeOld.HEADER_SEQ_MISMATCH, ErrorCodeOld.HEADER_PARSING_FAILED, ErrorCodeOld.INVALID_BPP, ErrorCodeOld.JSON_PROCESSING_ERROR, ErrorCodeOld.INVALID_ENTITY_TYPE, ErrorCodeOld.HTTP_TIMEOUT_ERROR, ErrorCodeOld.NETWORK_ERROR, ErrorCodeOld.CERTIFICATE_ALIAS_ERROR, ErrorCodeOld.CERTIFICATE_ERROR, ErrorCodeOld.SIGNATURE_ERROR, ErrorCodeOld.PROXY_AUTH_FAILED, ErrorCodeOld.INVALID_PROXY_KEY_ID_HEADER, ErrorCodeOld.INVALID_PROXY_AUTH_HEADER, ErrorCodeOld.PROXY_ALGORITHM_MISMATCH, ErrorCodeOld.PROXY_REQUEST_EXPIRED, 
        		ErrorCodeOld.INVALID_PROXY_HEADERS_PARAM, ErrorCodeOld.PROVIDER_NOTFOUND_ERROR, ErrorCodeOld.REQUEST_OR_RESPONSE_ALREADY_PROCESSED };
    }
}
